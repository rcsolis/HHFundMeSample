...
contract HHFundMe {
    ...
    */
    function fund() public payable{
        ...
        console.log("Received %s USD", usdReceived);
    ...
    */
    function withdraw() public OnlyOwner{
        ...
        console.log("Balance before withdraw: %s", address(this).balance);
    ...
    * @notice This function allows to get the higher funder
    * @dev This function is to get the higher funder using the internal funders mapping and itereate over the fundersAddr array
    ...
    * @dev This function is to check if an address already is a funder using the internal funders mapping
